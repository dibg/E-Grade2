...
CREATE TABLE IF NOT EXISTS `3163_3362_3374`.`course` (
  ...
  UNIQUE INDEX `courseName_deparment_UNIQUE` (`courseName` ASC, `department_departmentId` ASC),
...
CREATE TABLE IF NOT EXISTS `3163_3362_3374`.`grade` (
  ...
  UNIQUE INDEX `course_student_fk` (`course_courseId` ASC, `student_studentId` ASC),
